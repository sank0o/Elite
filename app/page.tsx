export default function EliteWomenStore() {
  return (
    <main className="min-h-screen bg-[#FCFAf8] text-[#1a1a1a] font-sans">
      ...
      <header className="relative h-[80vh] flex items-center justify-center bg-[#f3efeb] overflow-hidden">
        ...
        <div className="text-center z-10 px-4">
          <h2 className="text-[10px] uppercase tracking-[0.6em] mb-4 text-gray-600">مجموعة ربيع وصيف 2026</h2>
          <h1 className="text-6xl md:text-8xl font-serif italic mb-8 drop-shadow-sm">جمالكِ يبدأ من هنا</h1>
          <button className="bg-black text-white px-14 py-4 text-[11px] uppercase tracking-[0.3em] hover:bg-transparent hover:text-black border border-black transition-all duration-500">تسوقي الآن</button>
        </div>
      </header>

      {/* أقسام الفئات - Categories Sections */}
      <section className="max-w-7xl mx-auto py-24 px-6 space-y-36">
        
        {/* قسم الملابس - Clothing */}
